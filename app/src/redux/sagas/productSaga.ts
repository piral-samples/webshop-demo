...
function* handleAction(location, message, status) {
  if (location) {
    yield call((url) => history.pushState(undefined, undefined, url), location);
  }
  ...
  switch (type) {
    ...
    case ADD_PRODUCT: {
      try {
        ...
        yield handleAction(adminProducts, "Item succesfully added", "success");
        yield put(setLoading(false));
      } catch (e) {
        yield handleError(e);
        yield handleAction(
    ...
    case EDIT_PRODUCT: {
      try {
        ...
        yield handleAction(adminProducts, "Item succesfully edited", "success");
        yield put(setLoading(false));
      } catch (e) {
        yield handleError(e);
        yield handleAction(
